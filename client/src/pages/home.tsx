            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-card border rounded-lg p-6 space-y-3">
                  ...
                  <h3 className="font-semibold text-lg">Respectful Presentation</h3>
                  <p className="text-sm text-muted-foreground">
                    Designed with Islamic principles in mind, using geometric patterns and respectful imagery.
                  </p>
                </div>
                ...
                <div className="bg-card border rounded-lg p-6 space-y-3">
                  ...
                  <h3 className="font-semibold text-lg">Educational Purpose</h3>
                  <p className="text-sm text-muted-foreground">
                    Learn about the life, teachings, and impact of Prophet Muhammad ﷺ through interactive exploration.
                  </p>
                </div>
              </div>
            </div>
