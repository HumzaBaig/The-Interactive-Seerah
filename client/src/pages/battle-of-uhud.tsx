    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800 text-white overflow-hidden">
      ...
      <main className="relative z-10 container mx-auto px-6 pb-12">
        <div className="text-center mb-8">
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold font-display bg-gradient-to-r from-slate-200 via-slate-300 to-slate-200 bg-clip-text text-transparent pb-2">
              Battle of Uhud
            </h1>
          </div>
          ...
          <p className="text-sm text-slate-300/80 mt-2">7th Shawwal, 3 AH</p>
        </div>
            ...
            {currentStage === 3 && (
              <div className="mt-6">
                <Button
                  ...
                  variant="outline"
                  className="w-full bg-slate-500/20 border-slate-400/50 text-slate-200 hover:bg-slate-500/30 hover:text-slate-100"
