...
const expeditionStages = [
  ...
  },
  {
    ...
    location: "Madinah",
    description: "This expedition was called 'Jaysh al-Usra' (Army of Hardship). The heat was intense, the journey long (over 700 km), and it was harvest time. Resources were scarce - sometimes 18 men shared a single camel. The hypocrites made excuses and tried to discourage others. Despite this, 30,000 Muslims responded to the call.",
    icon: Sun
  },
  {
    id: "generosity",
    ...
    <div className="min-h-screen bg-gradient-to-b from-cyan-950 via-cyan-900 to-cyan-800 text-white overflow-hidden">
      ...
      <main className="relative z-10 container mx-auto px-6 pb-12">
        <div className="text-center mb-8">
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold font-display bg-gradient-to-r from-cyan-200 via-cyan-300 to-cyan-200 bg-clip-text text-transparent pb-1">
              Expedition of Tabuk
            </h1>
          </div>
