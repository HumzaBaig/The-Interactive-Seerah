...
export default function BattleOfKhaybar() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-950 via-red-900 to-red-800 text-white overflow-hidden">
      ...
      <main className="relative z-10 container mx-auto px-6 pb-12">
        <div className="text-center mb-8">
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold font-display bg-gradient-to-r from-red-200 via-red-300 to-red-200 bg-clip-text text-transparent pb-1">
              Conquest of Khaybar
            </h1>
          </div>
          ...
          <p className="text-sm text-red-300/80 mt-2">Muharram, 7 AH</p>
        </div>
          ...
          <div className="p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-red-300/80 text-sm">{stage.location}</p>
              </div>
            </div>
            ...
            {currentStage === 3 && (
              <div className="mt-6">
                <Button
                  ...
                  variant="outline"
                  className="w-full bg-red-500/20 border-red-400/50 text-red-200 hover:bg-red-500/30 hover:text-red-100"
