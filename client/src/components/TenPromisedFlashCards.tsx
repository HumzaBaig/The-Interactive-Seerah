      ...
      >
        ...
        >
          <div className="text-center space-y-3">
            ...
            <p className="text-xs text-emerald-600 dark:text-emerald-400 mt-4">Click to read bio</p>
          </div>
        </Card>
        ...
        >
          ...
          <p className="text-xs text-emerald-600 dark:text-emerald-400 mt-3">Click to flip back</p>
        </Card>
      </div>
    </div>
  );
