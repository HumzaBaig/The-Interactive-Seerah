...
function FlashCard({ wife }: { wife: WifeCard }) {
  ...
  return (
    ...
    >
      ...
      >
        <Card
          className="absolute inset-0 backface-hidden flex flex-col items-center justify-center p-6 bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20"
        ...
        >
          <div className="text-center space-y-3">
            ...
            <p className="text-xs text-primary mt-4">Click to read bio</p>
          </div>
        </Card>
        ...
        >
          ...
          <p className="text-xs text-primary mt-3">Click to flip back</p>
        </Card>
      </div>
    </div>
  );
